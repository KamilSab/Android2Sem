...
import ru.itis.android2sem.data.remote.interceptors.AuthInterceptor
...
object AppModule {
    ...
    fun provideRetrofit(client: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl(BuildConfig.CATAAS_BASE_URL)
            .client(client)
    ...
    @Provides
    @Singleton
    fun provideApiService(retrofit: Retrofit): CataasApi {
